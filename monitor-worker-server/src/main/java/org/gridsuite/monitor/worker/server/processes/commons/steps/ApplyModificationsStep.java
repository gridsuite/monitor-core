...
public class ApplyModificationsStep<C extends ProcessConfig> extends AbstractProcessStep<C> {
    ...
    public ApplyModificationsStep(NetworkModificationService networkModificationService, FilterService filterService) {
    ...
    private void applyModifications(List<UUID> modificationIds, Network network, ReportNode reportNode) {
        List<ModificationInfos> modificationInfos = networkModificationService.getModifications(modificationIds);
